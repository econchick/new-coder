...
Open up `parse.py`, found: [new-coder/dataviz/lib/tutorial_source/parse.py](https://github.com/econchick/new-coder/blob/master/dataviz/lib/tutorial_source/parse.py)
...
[The begining of the module](https://github.com/econchick/new-coder/blob/master/dataviz/lib/tutorial_source/parse.py#4) is an introduction as well as any copyright and/or license information.
...
Within the `new-coder/dataviz/lib/` directory, let’s make a directory for the python files you are writing with the bash command `mkdir [Directory_Name]`:
