...
<div class="panel panel-default">
  <div class="panel-heading">For the Curious</div>
  <div class="panel-body">
We were able to call the <code>.next</code> method on <code>csv_data</code> because it is a generator. We only call <code>.next</code> once, since headers are in the 1st and only row of our CSV file.
</div>
</div>
